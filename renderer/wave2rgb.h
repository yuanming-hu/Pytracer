...
double get_refraction_ratio(double wl) {
    return 1 - 40 / wl;
    wl = wl / 1e9;
    const double B1 = 1.040, B2 = 0.232, B3 = 1.010;
    const double C1 = 6e-15, C2 = 2e-14, C3= 1e-10;
    wl = wl * wl;
    return 1 + wl * (B1 / (wl - C1) + B2 / (wl - C2) + B3 / (wl - C3));
}
